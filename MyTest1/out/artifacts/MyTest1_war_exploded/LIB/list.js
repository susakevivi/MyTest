...
$(document).ready( function() {
	...
	$searchPropertyOption.click( function() {
		var $this = $(this);
		$('#searchPropertySelect').html($this.html());
		$('#searchLabel').attr('value', $this.text());
		$('#searchName').attr('value', $this.attr("val"));
		$('#searchValue').attr('name', $this.attr("val"));
		$('#searchValueOp').attr('name', $this.attr("val") + '_op');
		$this.parents('div.popupMenu').hide();
	...
	$listForm.submit(function() {
		//if (!/^\d*[0-9]\d*$/.test($pageNumber.val())) {
			$pageNumber.val("0");
		//}
